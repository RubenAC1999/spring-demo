...
public class EmployeeController {
    ...
    @Operation(summary = "Get current employee data")
    ...
    @Operation(summary = "List employees by position")
    ...
    @Operation(summary = "Assign a project")
    ...
    public ResponseEntity<EmployeeResponseDTO> assignProject(
            @PathVariable UUID uuid,
    ...
    @Operation(summary = "Unassign project")
    ...
    public ResponseEntity<EmployeeResponseDTO> unassignProject(
            @PathVariable UUID uuid,
            @PathVariable UUID projectUuid) {
